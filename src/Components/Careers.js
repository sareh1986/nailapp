  ...
  render() {
    return (
      ...
      >
        ...
        <div className="p-3 col-6 d-flex align-items-center">
            <h2 className="text-pink font-weight-bold my-0">همکاری با ما</h2>
          </div>
          <div className="p-3 col-6">
            <img src={Logo} className="float-left mw-100 d-block" height="60" />
          </div>
          ...
          <div className="col-9 d-flex flex-wrap mx-auto">
            ...
            <div className="my-2 col-9 d-flex flex-wrap px-0">
              <span className="align-items-center d-flex col-4">
                <input className="box-search mx-1" type="checkbox" />
                خدمات ناخن
              </span>
              <span className="align-items-center d-flex col-4">
                <input className="box-search mx-1" type="checkbox" />
          ...
          <div className="col-9 d-flex flex-wrap mx-auto">
            <span className="col-3 d-flex align-items-center">تصویر مدارک</span>
            <div className="my-2 col-9 px-0">
              <input className="box-search" type="file" />
            </div>
          </div>
